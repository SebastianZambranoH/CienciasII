...
class GraphController:
    ...
    def build_graph(self, vertices):
        ...
        self._traffic.assign_random_traffic(graph)
    ...
    def assign_nodes_to_locations(self, locations, graph):
        """Para ubicaciones con coordenadas reales (estaciones, hospitales)."""
    ...
    def assign_random_nodes(self, locations, graph, occupied_nodes):
        """Para ubicaciones sin coordenadas reales (emergencias, vehiculos)."""
        import random
